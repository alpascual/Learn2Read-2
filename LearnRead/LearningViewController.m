...
@synthesize firstLetter, secondLetter, thirdLetter, fouthLetter;
...
{        
    ...
    self.fouthLetter.text = [randomWord substringWithRange:NSMakeRange(3, 1)];
        
    
    self.highlightTimer = [NSTimer scheduledTimerWithTimeInterval: 2.5 target: self selector: @selector(timerCallback:) userInfo: nil repeats: YES];
...
- (void)timerCallback:(NSTimer *)timer {
    ...
    self.fouthLetter.highlighted = NO;
    ...
    {
        self.fouthLetter.highlighted = YES;
        //Play the letter
        [self.sound addSoundToQueue:self.fouthLetter.text];
        [self.sound playQueue];
    }
    else if (countLetters == 5 )
    {
        //Play the word
